...
switch (ENVIRONMENT) {
				case 'production':
								$config['base_url'] = 'http://cheapskate-boytimes.rhcloud.com/';
								break;
				case 'development':
				default:
...
|
*/
$config['encryption_key'] = 'gggggy65#SSa78908jnqp5@2210jbexA';
...
$config['csrf_token_name'] = 'csrf_cheapskate_token';
$config['csrf_cookie_name'] = 'csrf_cheapskate_name';
